...
public class SphereRepository {
    private static final Logger LOGGER = LogManager.getLogger(SphereRepository.class);
    ...
    public Sphere update(int id, Sphere sphere) {
        LOGGER.log(Level.INFO, "update with id: {} obj : {}", id, sphere);
